...
void sortUsingPtrs(vector<Student>& students, bool comp(const Student*, const Student*))
{
    ...
    sort(studentPointers.begin(), studentPointers.end(), comp);
      ...
      //        order.
    for (int i = 0; i<studentPointers.size(); i++)
    {
