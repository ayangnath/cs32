...
//  32homework3
//
//  Created by Ayan Nath on 2/12/23.
//
...
int countIsIn(const double a1[], int n1, const double a2[], int n2)
{
    ...
    if (a1[0] == a2[0])
        tracker = countIsIn(a1+1, n1-1, a2+1, n2-1);

    return tracker + countIsIn(a1, n1, a2+1, n2-1);
}
...
int main()
{
    ...
    double a1[3] = {10, 20, 40}; //    10 20 40                        1
    //   double a1[3] = {10, 40, 30}; //    10 40 30                      2
    //    double a1[3] = {20, 10, 40}; //    20 10 40                      0
    //   double a1[3] = {50, 40, 30}; //    50 40 30                      3
    //

        std::cout << countIsIn(a1, 3, a2, 7);
